...
<body>
		...
		<div id="header">
			...
			<div id="headerName" onclick = "window.location.href = 'home.php'" ><span class="headerIconShow">$</span> Budgetify <span class="headerIconShow">&#9998;</span></div>
			<?php
		...
		<div id = "content" style="margin-top:90px">
			...
			<div id="contentAbout">
				<div style="text-align:left;padding:20px 30px">
					<h4>About Site:</h4>
					<li style="list-style-type:circle">Budgetify is a utility site for maintaining and managing Money related data developed using </li>
					...
					<h4>Functionalities:</h4>
						...
						<h4>Future Scope:</h4>
							<div style="padding:0 20px">
								<li>Developing this website into a application(both Andriod and Iphone)</li>
								<li>Linking with bank institution with APIs(Plaid or Yodlee or Open-Banking) for auto transactions</li>

							</div>
					<h4>About the developer:</h4>
					<li style="list-style-type:circle">Developed by <a style="color:blue" target="_blank" href="https://github.com/Selva-NSK">Selva,Sunil,Samuel,Sandeep</a></li>
					<li style="list-style-type:circle">Site Version v1.0 <small>(09-04-2023)</small></li>
					<br><br><br>
				</div>
			</div>
		</div>
